...
{
    /// <inheritdoc />
    public partial class SeedSampleSellersWithStaticValues : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "seller-1", "It's a simple bio!", new DateTime(2002, 7, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hasib Hasnain", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { "seller-2", "Honest and Elegent Seller!", new DateTime(2000, 3, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rahim Iqbal", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { "seller-3", "Selling My Used Bat Balls!", new DateTime(1997, 9, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tamim Iqbal", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
        }
